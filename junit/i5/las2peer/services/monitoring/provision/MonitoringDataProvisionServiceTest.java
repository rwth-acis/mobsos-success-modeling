...
public class MonitoringDataProvisionServiceTest {
	...
	private static final ServiceNameVersion testServiceClass = new ServiceNameVersion(MonitoringDataProvisionService.class.getCanonicalName(),"0.1");
	...
	public void getMeasuresAndModels() {
		...
		try {
			...
			result = c.invoke(testServiceClass.getName(), "visualizeServiceSuccessModel", "Chat Service Success Model", true, true);
			assertTrue(result instanceof String);
