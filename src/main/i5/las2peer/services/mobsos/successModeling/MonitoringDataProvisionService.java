...
public class MonitoringDataProvisionService extends RESTService {
    ...
    void writeSuccessModel(String xml, String group, String expectedServiceName) throws MalformedXMLException, FileBackendException {
