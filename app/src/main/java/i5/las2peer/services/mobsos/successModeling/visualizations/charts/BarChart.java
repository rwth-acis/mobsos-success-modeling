...
/**
*
* Converts a {@link MethodResult} into a Google Bar-Chart.
* <br>
...
public class BarChart {
	...
	/**
	*
	* Constructor of a BarChart.
	*
	* @param methodResult
	* @param visualizationParameters a String of parameters: [div-Id, title, height, width]
	*
	*/
	public BarChart(MethodResult methodResult, String[] visualizationParameters) {
		...
		resultHTML += "var chart = new google.visualization.BarChart(document.getElementById('" + divId + "'));\n";
